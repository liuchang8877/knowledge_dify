...
test_workflow("What is the capital?", "c80d5480-1820-4279-a18a-3eab3442e4a7")

# 测试用例 2：传入另一个 knowledge_id
#test_workflow("What is the capital?", "e490ab8f-1304-4a84-8b53-334e19d548d8")  # 替换为另一个有效 ID
